...
namespace Atom.CircuitBreaker.Commands
{
    ...
    public abstract class AsyncCommand<TResult> : BaseCommand
    {
        ...
        protected AsyncCommand(ICommandContext ctx, string group, string isolationKey, TimeSpan defaultTimeout)
        ...
        /// <param name="defaultTimeout">Timeout to enforce if not otherwise provided.</param>
        protected AsyncCommand(ICommandContext ctx, string group, string breakerKey, string bulkheadKey, TimeSpan defaultTimeout)
